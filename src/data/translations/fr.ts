...
Shubham a donc créé Meena Hope Foundation, l’association référente locale indienne de nos projets, et moi j’ai créé Le Colibri Indien, l’association qui communique sur nos actions et qui gère les fonds depuis la France.`,
		legend: "La légende du colibri, l’inspiration de notre association",
		legendText: `La légende Amérindienne du Colibri raconté par Pierre Rabhi :
 « Un jour, dit la légende, il y eut un immense incendie de forêt. Tous les animaux terrifiés, atterrés, observaient impuissants le désastre. Seul le petit colibri s’activait, allant chercher quelques gouttes avec son bec pour les jeter sur le feu. Après un moment, le tatou, agacé par cette agitation dérisoire, lui dit : « Colibri ! Tu n’es pas fou ? Ce n’est pas avec ces gouttes d’eau que tu vas éteindre le feu ! »
Et le colibri lui répondit : « Je le sais, mais je fais ma part. » 
La morale de la légende du colibri :
Plutôt que de ne rien faire face aux problèmes sociaux, environnementaux ou économiques actuels parce que l’on se sent impuissant ou que l’on pense que la solution doit venir des autres, on peut agir avec ses compétences et à son échelle.
Et même si, pris isolément, nos actes semblent dérisoires, c’est grâce à la somme des actions des colibris que les choses changent. J’ajouterais à cette légende cette citation de Gandhi :
...
Il nous semble que la sobriété est le chemin indispensable pour questionner notre vie et nos impacts. Ce sont ces petits pas de colibri qui nous emmènent ensuite vers plus d’autonomie, puis de coopération. Et c’est là qu’on peut agir tous ensemble avec force.`,
		goals: "Nos objectifs",
