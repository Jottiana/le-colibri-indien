export const en = {
	home: {
		...
		card2Text: "Our charity gala took place on May 31, 2025.",
	...
	legalNotice: {
		...
		organization:
			"Address: 18 rue de l'Ancienne Ecole 72290 Courceboeufs, France.\nMail: lecolibriindien@gmail.com",
